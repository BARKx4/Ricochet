...
if ($failures.Count -eq 0) {
    ...
    $requiredExamples = @(
        ...
        "rco app [--backend winui] [--export-ui-json PATH] [--replay-events PATH] [--winui-host PATH] &lt;path&gt; [args...]",
        "rco package [path] --output &lt;exe&gt; [--tui] [--gui] [--mvc] [--gui-launcher PATH] [--app] [--backend winui] [--app-launcher PATH] [--linux-package tar|deb] [--package-name NAME] [--package-version VERSION]",
