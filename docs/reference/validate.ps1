...
if ($failures.Count -eq 0) {
    ...
    $requiredExamples = @(
        ...
        "rco fmt [--check] [path]",
        "rco run-bytecode [--debug] [--capability-profile trusted|sandboxed] [--no-fs] [--fs-root PATH] [--fs-readonly] [--no-http] [--no-webview] [--allow-webview] [--http-allow-host HOST] &lt;path&gt; [args...]",
        "rco gui [--capability-profile trusted|sandboxed] [--no-fs] [--fs-root PATH] [--fs-readonly] [--no-http] [--no-webview] [--allow-webview] [--http-allow-host HOST] &lt;path&gt; [args...]",
        "rco package [path] --output &lt;exe&gt; [--gui] [--mvc] [--gui-launcher PATH] [--linux-package tar|deb] [--package-name NAME] [--package-version VERSION]",
        ...
        "`"/dashboard`" redirect",
        "rco routes [path]",
        "rco test [--debug] [--filter PATTERN] [--capability-profile trusted|sandboxed] [--no-fs] [--fs-root PATH] [--fs-readonly] [--no-http] [--no-webview] [--allow-webview] [--http-allow-host HOST] [path]",
        "task get .status",
        "`"Counter`" 1 webview .heading",
        "`"Increment`" `"increment`" webview .button",
        "tasks .count",
        "fs .read-text",
        "http .get",
        "http .get-task",
