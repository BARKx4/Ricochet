...
if ($failures.Count -eq 0) {
    ...
    $requiredExamples = @(
        ...
        "rco fmt [--check] [path]",
        "rco run-bytecode [--debug] [--capability-profile trusted|sandboxed] [--no-fs] [--fs-root PATH] [--fs-readonly] [--no-http] [--no-tui] [--allow-tui] [--no-webview] [--allow-webview] [--http-allow-host HOST] &lt;path&gt; [args...]",
        "rco gui [--capability-profile trusted|sandboxed] [--no-fs] [--fs-root PATH] [--fs-readonly] [--no-http] [--no-tui] [--allow-tui] [--no-webview] [--allow-webview] [--http-allow-host HOST] &lt;path&gt; [args...]",
        "rco tui [--capability-profile trusted|sandboxed] [--no-fs] [--fs-root PATH] [--fs-readonly] [--no-http] [--no-tui] [--allow-tui] [--no-webview] [--allow-webview] [--http-allow-host HOST] &lt;path&gt; [args...]",
