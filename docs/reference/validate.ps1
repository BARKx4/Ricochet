...
if ($failures.Count -eq 0) {
    ...
    $requiredExamples = @(
        ...
        "rco fmt [--check] [path]",
        "rco run-bytecode [--debug] [--no-fs] [--fs-root PATH] [--fs-readonly] [--no-http] [--http-allow-host HOST] &lt;path&gt; [args...]",
        ...
        "`"/dashboard`" redirect",
        "rco routes [path]",
        "rco test [--debug] [--filter PATTERN] [--no-fs] [--fs-root PATH] [--fs-readonly] [--no-http] [--http-allow-host HOST] [path]",
        "task get .status",
        "tasks .count",
        "fs .read-text",
        "http .get",
