...
if ($failures.Count -eq 0) {
    ...
    $requiredExamples = @(
        ...
        "rco app [--backend winui|avalonia|slint] [--export-ui-json PATH] [--replay-events PATH] [--winui-host PATH] [--avalonia-host PATH] [--slint-validate-only] &lt;path&gt; [args...]",
        "rco package [path] --output &lt;exe&gt; [--tui] [--gui] [--mvc] [--gui-launcher PATH] [--app] [--backend winui|avalonia|slint] [--app-launcher PATH] [--linux-package tar|deb] [--package-name NAME] [--package-version VERSION]",
