...
if ($failures.Count -eq 0) {
    ...
    $requiredExamples = @(
        ...
        "rco fmt [--check] [path]",
        "rco run-bytecode [--debug] [--capability-profile trusted|sandboxed] [--no-fs] [--fs-root PATH] [--fs-readonly] [--no-http] [--allow-process] [--process-root PATH] [--allow-pty] [--no-tui] [--allow-tui] [--no-webview] [--allow-webview] [--no-env] [--env-allow NAME] [--no-sleep] [--http-allow-host HOST] &lt;path&gt; [args...]",
        ...
        "rco publish [path] --registry PATH [--dry-run]",
        "rco verify [path]",
        "rco audit [path] [--json]",
