...
pub use opaque::{HostTokenError, HostTokenSource, SecretRef, SecurityDomainId};
pub use session::{
    SecretSession, SecretSessionContext, SecretSessionError, SecretSessionErrorKind,
    SecretSessionGuard, SessionSecretPrompt,
};
