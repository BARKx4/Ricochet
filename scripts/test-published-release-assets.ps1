...
function New-Fixture {
    param(
        [string] $RootPath,
        [string] $AssetName = "ricochet_0.1.19.rc.6_amd64.deb",
        [bool] $Draft = $true,
...
Invoke-Case "GitHub-renamed asset" (New-Fixture (Join-Path $FixtureRoot "renamed") -ApiAssetName "ricochet_0.1.19~rc.6_amd64.deb") $false
Invoke-Case "API asset case mismatch" (New-Fixture (Join-Path $FixtureRoot "api-case") -ApiAssetName "Ricochet_0.1.19.rc.6_amd64.deb") $false
Invoke-Case "checksum asset case mismatch" (New-Fixture (Join-Path $FixtureRoot "checksum-case") -ChecksumAssetName "Ricochet_0.1.19.rc.6_amd64.deb") $false
...
Invoke-Case "unsafe local filename" (New-Fixture (Join-Path $FixtureRoot "unsafe") -AssetName "ricochet_0.1.19~rc.6_amd64.deb") $false
